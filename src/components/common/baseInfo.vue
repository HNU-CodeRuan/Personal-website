<template>
  <header class="content-hd">
    ...
    <section class="info">
      <ul>
        <li>男 / 1999.11</li>
        <li><a href="http://www.lnpu.edu.cn/">辽宁石油化工大学（抚顺石油学院)</a></li>
        <li>软件工程</li>
        <li>本科 / 2022年6月毕业</li>
      </ul>
    </section>
    <section class="contact">
      <ul>
        ...
        <li>
          <a href="https://github.com/XCRCC" target="_blank">
            <span class="contact-link">Github - XCRCC</span>
            <span class="iconfont">
              <svg width="16px" height="16px" viewBox="0 0 1024 1024">
                <path
        ...
        <li>
          <a href="mailto:2399868430@qq.com" target="_blank">
            <span class="contact-link">2399868430@qq.com</span>
            <span class="iconfont">
              <svg width="16px" height="16px" viewBox="0 0 1024 1024">
                <path
